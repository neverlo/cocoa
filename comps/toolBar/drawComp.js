var drawComp = {
	init : function(logoList,backEvent){
		var jsonDatas = [{
			'title':'标注工具','value':'marker','logo':'data:image/png;base64,'
		},{
			'title':'画动态线','value':'dynamicLine','logo':'data:image/png;base64,'
		},{
			'title':'添加文字','value':'text','logo':'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAASklEQVR4AWOgGMRc+P8ViP+TiJ/ANN8B4r3ohsIUYhG/BMTrYJxjQGxKguZqIC6HcYxBNAmaJYBYFi5AWDMmGLqaRzUTStMM1AIASf+oWxkgWrEAAAAASUVORK5CYII='
		},{
			'title':'画箭头','value':'arrow','logo':'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAaklEQVR4AWOgGYi58P8/LkyRARS5gFiNMUD8B1MzYY0JMI3oBhDSmArEf5E0xiJ7AZ/GTCD+B1IEpRPRwwCXxlw0jSnEBk4xWBNCYxaxGsvRQjSfWI01aBqLSEkEDUgaK2DipBpQx0AvAADQsNM8Yuz3HgAAAABJRU5ErkJggg=='
		},{
			'title':'画多边形','value':'polygon','logo':'data:image/png;base64,'
		},{
			'title':'画静态线','value':'staticLine','logo':'data:image/png;base64,'
		}];
