var drawComp = {
	init : function(logoList,backEvent){
		var jsonDatas = [{
			...
			'title':'画圆形','sTitle':'取消画圆形','value':'circle','logo':'data:image/png;base64,'
		},{
			'title':'画矩形','sTitle':'取消画矩形','value':'regularPolygon','logo':'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAIklEQVR4AWMYWKC8/M5/UjGK5pgL/4nFQ0vzqGbKEsnQBQAYQIWSy81cdwAAAABJRU5ErkJggg=='
		},{
