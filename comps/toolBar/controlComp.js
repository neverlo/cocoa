var controlComp={
	init : function(logoList,backEvent){
        var jsonDatas = [{
			...
			'title':'删除当前图层','sTitle':'删除当前图层','value':'delete','logo':'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAAPCAYAAAA71pVKAAAAPElEQVR4AWOgCoi58P8/CJMkj5BAYJLkERIITEiOoAH4NJJsAMGAw6eRdpqp6l+yQxqfHEWJhKLkOfAAAO/HIyhTHziTAAAAAElFTkSuQmCC'
		},{
