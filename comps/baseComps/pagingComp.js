...
var pagingComp = {
	...
	startPage : function(){
		...
		T(this.focusId).addComps(tempArr);
	},
	pageButton : function(){
		...
		this.pageE = T(this.pageE).compRecord(this.focusId,parentE);
		return parentE;
	},
