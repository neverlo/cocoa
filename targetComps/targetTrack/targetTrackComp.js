var targetTrackComp = {
	initMin : function(focusDivId){
		...
		compTools.addComps(focusDivId,[trackmin6,trackmin7]);
	},
	initMax : function(focusDivId){
		...
		var trackmin6 = trackComp.init(jsonDatas6);
		var trackmin7 = trackComp.init(jsonDatas7);
		pagingComp.init(focusDivId,[trackmin1,trackmin2,trackmin3,trackmin4,trackmin5,trackmin6,trackmin7],6);
	},
